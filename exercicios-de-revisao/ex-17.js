...
const menoresComAnimais = usuarios.filter(usuario => usuario.idade < 18 && usuario.temAnimalEstimacao);

menoresComAnimais.forEach(usuario => {
  console.log(`${usuario.nome} ${usuario.sobrenome} tem ${usuario.idade} anos e tem um animal de estimação.`);
}); 